...
import 'package:app4_receitas/utils/theme/locale_controller.dart';
  ...
  Widget _animatedLogo({required AnimationController controller}) {
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        ...
        final sizeTween = Tween(begin: 50.0, end: 200.0).animate(CurvedAnimation(parent: controller, curve: Curves.easeInOut));
