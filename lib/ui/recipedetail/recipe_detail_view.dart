              ...
              child: Column(
                children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center,children: [
                    ElevatedButton(onPressed: () => context.go('/'), child: Text('VOLTAR')),
                    ElevatedButton(onPressed: () => viewModel.toggleFavorite(), child: Text(viewModel.isFavorite? 'DESFAVORITAR' : 'FAVORITAR')),
                  ],) 
                ],
              ),
            ),
